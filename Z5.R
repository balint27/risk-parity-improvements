...
#=============================================================================
# IMPROVED EWMA COVARIANCE ESTIMATION - KEEPING FROM Z4.3.R
#=============================================================================
...
# Calculate Z-scores with improved smoothing (from Z2.1.R)
...
# Map asset class weights to ETF weights
...
calculate_portfolio_performance <- function(
  ...
  for (i in 1:nrow(prices)) {
    ...
    if (date %in% rebalance_dates || i == 1) {
      ...
      # Update to the calculate_portfolio_performance function in Part 3
      # Update to the calculate_portfolio_performance function in Part 3
      # Replace the turnover calculation section with this fixed version
...
cat("\nPart 3 loaded: Backtesting and performance evaluation\n")
#=============================================================================
# ENHANCED RISK PARITY TRADING SYSTEM - COMPREHENSIVE VERSION (Z4.4.R)
...
# Log system information
cat("\n========================================================\n")
cat(sprintf("Enhanced Risk Parity System Z4.4.R\n"))
cat(sprintf("Current Date and Time (UTC): %s\n", format(Sys.time(), "%Y-%m-%d %H:%M:%S")))
cat("========================================================\n")
